package com.github.leftisttachyon.epsilon.blob;
...
public final class ContainerModel implements Serializable {
    ...
    private static final String ACCOUNT_NAME = "epsilonblob";
    private static final String ACCOUNT_KEY = System.getenv("ACCOUNT_KEY");
     ...
     *                      thrown.
     * @see ContainerModel#ContainerModel(String, boolean)
     */
    public ContainerModel(String containerName) {
     ...
     */
    public ContainerModel(String containerName, boolean checkForCreation) {
        if (CREDS == null) {
